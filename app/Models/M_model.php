...
class M_model extends model
{
	...
	public function filterAbsensi($table, $awal, $akhir) {
		return $this->db->query(
			"SELECT *
			FROM ".$table."
			JOIN user ON ".$table.".maker_absensi=user.id_user
	...
	public function filterPerizinan($table, $awal, $akhir) {
		return $this->db->query(
			"SELECT *
			FROM ".$table."
			JOIN user ON ".$table.".maker_ps=user.id_user
			WHERE ".$table.".tanggal_ps
			BETWEEN '".$awal."'
			AND '".$akhir."'"
		)->getResult();
	}

	public function filterPeminjaman($table, $awal, $akhir) {
		return $this->db->query(
			"SELECT *
			FROM ".$table."
	...
	public function filterAbsensiWhere($table, $awal, $akhir, $where) {
	    return $this->db->query(
	        "SELECT *
	        FROM ".$table."
	        JOIN user ON ".$table.".maker_absensi=user.id_user
	...
	public function filterPerizinanWhere($table, $awal, $akhir, $where) {
	    return $this->db->query(
	        "SELECT *
	        FROM ".$table."
	        JOIN user ON ".$table.".maker_ps=user.id_user
	...
	public function filterPeminjamanWhere($table, $awal, $akhir, $where) {
	    return $this->db->query(
	        "SELECT *
	        FROM ".$table."
	        JOIN barang ON ".$table.".id_barang_pp=barang.id_barang
...
// 	}
	...
	public function superWhere($table1, $table2, $table3, $on, $on2, $where)
	{
