...
<body>
    ...
    <div class="card-body">
      <div class="basic-form">
          <form id="userForm" class="form-horizontal form-label-left" novalidate  action="<?= base_url('Data_Master/aksi_tambah_guru')?>" method="post">
              ...
              <div class="row">
                  ...
                  <div class="mb-3 col-md-6">
                      ...
                      class="form-control text-capitalize" placeholder="Nama Guru">
                  </div>
                  <div class="mb-3 col-md-6">
