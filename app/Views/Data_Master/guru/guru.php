      ...
      <div class="table-responsive">
        <div class="container mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1></h1>
                <a href="<?= base_url('Data_Master/tambah_guru/')?>"><button class="btn btn-success custom-button"><i class="fa fa-plus"></i> Tambah</button></a>
            </div>
        </div>
        ...
        <table id="example" class="table items-table table table-bordered table-striped verticle-middle table-responsive-sm" style="min-width: 100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;" class="text-capitalize"><?php echo $dataa->nama_guru?></td>
              ...
              <td style="text-align: center;" class="text-capitalize"><?php echo $dataa->tanggal_guru?></td>
              <td>
              <div class="text-center mb-1">
                <a href="<?= base_url('Data_Master/reset_guru/'.$dataa->id_guru_user)?>" class="mx-2">
                  <i class="fa-solid fa-key text-info"></i>
                </a>

                <a href="<?= base_url('Data_Master/edit_guru/'.$dataa->id_guru_user)?>" class="mx-2">
                  <i class="fa-regular fa-pen-to-square text-warning"></i>
                </a>

                <a href="<?= base_url('Data_Master/hapus_guru/'.$dataa->id_guru_user)?>" class="mx-2">
